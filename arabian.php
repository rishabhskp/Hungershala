...
if($_SESSION['restaurant']!="arabian")
	unset($_SESSION['dishes']);
$_SESSION['restaurant']="arabian";
$logged=1;
?>
<!DOCTYPE html>
<html lang="en-Us">
<head>
<title>Arabian -- Order Online @ Hungershala.com</title>
...
<h2>Categories</h2>
<?php
$categories = mysql_query("SELECT DISTINCT category FROM menu_arabian");
echo "<ul>";
...
while($category = mysql_fetch_array($categories)) {
	...
	$dishes = mysql_query("SELECT * FROM menu_arabian WHERE category='$category[category]'");
